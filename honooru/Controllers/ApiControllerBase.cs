...
namespace honooru.Controllers {
    ...
    public abstract class ApiControllerBase : Controller {
        ...
        protected ApiResponse<T> ApiRedirectFound<T>(string url) => new ApiResponse<T>(302, url);
        ...
        protected ApiResponse ApiRedirectFound(string url) => new ApiResponse(302, url);
