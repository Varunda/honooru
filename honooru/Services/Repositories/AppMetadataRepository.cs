...
namespace honooru.Services.Repositories {
    ...
    public class AppMetadataRepository {
        ...
        private readonly ILogger<AppMetadataRepository> _Logger;
        private readonly AppMetadataDbStore _Db;
        private readonly IMemoryCache _Cache;

        private const string CACHE_KEY = "App.Metadata.{0}"; // {0} => key

        public AppMetadataRepository(ILogger<AppMetadataRepository> logger,
            AppMetadataDbStore db, IMemoryCache cache) {
    ...
    public static class AppMetadataRepositoryExtensions {
        ...
        /// </exception>
        public static async Task<bool?> GetAsBoolean(this AppMetadataRepository repo, string key) {
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public static async Task Upsert(this AppMetadataRepository repo, string key, bool value) {
